...
## Project Structure
    ...
    ├── testapplications_de_32560  # Django project configurations
...
1. Clone this repo and `cd testapplications_de_32560`
...
2. Clone this repo and `cd testapplications_de_32560`
